...
public sealed class AreaVisualDataEntity : BaseEntity
{
    ...
    public static readonly HashSet<Enums.GSS.Controllers> ValidViews = new()
    {
        Enums.GSS.Controllers.AreaVisualData_ObserverView,
        Enums.GSS.Controllers.AreaVisualData_ForceShieldView,
        Enums.GSS.Controllers.AreaVisualData_LootObjectView,
        Enums.GSS.Controllers.AreaVisualData_MapMarkerView,
        Enums.GSS.Controllers.AreaVisualData_ParticleEffectsView,
        Enums.GSS.Controllers.AreaVisualData_TinyObjectView,
    };
    ...
    {
        view.GetType().GetProperty($"{propertyName}_{index}").SetValue(view, data, null);
    }

    private void ClearIndexOfArrayProperty(IAeroViewInterface view, string propertyName, uint index)
    {
        view.GetType().GetProperty($"{propertyName}_{index}").SetValue(view, null, null);
    }
    ...
    private uint GetFreeIndexOfArrayProperty(IAeroViewInterface view, string propertyName, uint max)
    {
        ...
        {
            var obj = view.GetType().GetProperty($"{propertyName}_{i}").GetValue(this);
            if (obj == null)
            {
